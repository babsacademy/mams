...
<div class="space-y-10">
    ...
    <div>
        @switch($tab)
            @case('boutique')
                <livewire:admin.settings.tabs.boutique :key="'settings-tab-boutique'" />
                @break
            @case('logistique')
                <livewire:admin.settings.tabs.logistique :key="'settings-tab-logistique'" />
                @break
            @case('profil')
                <livewire:admin.settings.tabs.profil :key="'settings-tab-profil'" />
                @break
            @case('mot-de-passe')
                <livewire:admin.settings.tabs.mot-de-passe :key="'settings-tab-mot-de-passe'" />
                @break
            @case('apparence')
                <livewire:admin.settings.tabs.apparence :key="'settings-tab-apparence'" />
                @break
            @case('securite-2fa')
                <livewire:admin.settings.tabs.securite-2fa :key="'settings-tab-securite-2fa'" />
                @break
            @default
                <livewire:admin.settings.tabs.boutique :key="'settings-tab-boutique-default'" />
        @endswitch
    </div>
</div>
